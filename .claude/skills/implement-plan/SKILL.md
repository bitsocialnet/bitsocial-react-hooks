...
6. Integrate the changes, inspect the final diff, and run the required checks once for the final state. Browser checks, when relevant, use the repository e2e harness with sequential engines and explicit process ownership.
