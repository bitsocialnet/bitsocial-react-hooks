...
Use `type: short description`, with an optional concise scope when useful. Types: `fix`, `feat`, `perf`, `refactor`, `docs`, `chore`; use `perf` for performance changes. Add a short body only when it explains something the title cannot.
